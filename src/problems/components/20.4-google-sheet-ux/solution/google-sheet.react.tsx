...
import { type CellId, isCellReference } from '../../20.1-google-sheet-parser/solution/parser'
import { TableEngine } from '../../20.3-google-sheet-engine/solution/table-engine'
export const COLS = [
  'A',
  'B',
  'C',
  ...
  return (
    <section onClick={handleClick}>
      ...
      <output className={cx(css.formula, styles.w100)}>
        <input
          ref={formulaRef}
          className={cx(css.formula, styles.w100)}
          id="formula"
          type="text"
          readOnly
        />
